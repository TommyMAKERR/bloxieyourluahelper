    ...
    <div className="min-h-screen grid-bg flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-md rounded-3xl border border-border bg-card/60 backdrop-blur-sm p-8 shadow-card">
        ...
        <button
          onClick={google}
          disabled={busy}
          className="w-full mb-4 flex items-center justify-center gap-2 rounded-xl border border-border bg-secondary/40 px-4 py-2.5 text-sm font-semibold transition hover:border-primary hover:bg-secondary disabled:opacity-50"
        >
